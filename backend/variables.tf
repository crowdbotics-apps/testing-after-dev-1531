variable "app_name" {
  ...
  type = "string"
  default = "testing-after-dev-1531"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "testing-after-dev-1531.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/testing-after-dev-1531/archive/master.tar.gz"
}
